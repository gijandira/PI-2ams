      ...
      <div className="ag-mobile" style={{ minHeight:'100vh', background:'var(--bg)', display:'flex', flexDirection:'column', paddingTop:60 }}>
        ...
        <div style={{ display:'flex', justifyContent:'flex-end', padding:'0 16px 12px' }}>
          <button onClick={handleLogout} style={{
            padding:'10px 14px', borderRadius:14, background:'linear-gradient(135deg,#ff5f5f,#d93636)',
            border:'none', color:'#fff', fontWeight:800, cursor:'pointer', boxShadow:'0 6px 18px rgba(255,0,0,.25)'
          }}>
            🚪 Sair
          </button>
        </div>
